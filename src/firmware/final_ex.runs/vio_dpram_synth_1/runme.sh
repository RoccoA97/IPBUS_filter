...
HD_PWD='/home/antonio/Lab9/Progetto/firmware/Lab9.runs/vio_dpram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_dpram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_dpram.tcl
