...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot vio_dpram xil_defaultlib.vio_dpram -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vio_dpram -key {Behavioral:sim_1:Functional:vio_dpram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vio_dpram.wdb xsim.dir)
